...
$_lang['managerbuttons_settings_background_help'] = 'Пустое значение — серый фон. Его получают кнопки без своего цвета.';
$_lang['managerbuttons_settings_color'] = 'Цвет текста';
$_lang['managerbuttons_settings_color_help'] = 'Пустое значение — тёмный текст.';
...
$_lang['setting_managerbuttons.background_desc'] = 'Фон кнопок по умолчанию. Пустое значение — серый.';
$_lang['setting_managerbuttons.color'] = 'Цвет текста кнопок';
$_lang['setting_managerbuttons.color_desc'] = 'Цвет текста кнопок по умолчанию. Пустое значение — тёмный текст.';
